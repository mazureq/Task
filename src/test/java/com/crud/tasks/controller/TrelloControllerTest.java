...
public class TrelloControllerTest {
    ...
    public void ShouldFetchTrelloBoards() throws Exception {
        ...
        mockMvc.perform(get("/v1/trello/getTrelloBoards").contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$[0].name", is("BoardName")))

                .andExpect(jsonPath("$[0].lists", hasSize(1)))
                .andExpect(jsonPath("$[0].lists[0].id", is("1")))
                .andExpect(jsonPath("$[0].lists[0].name", is("name")))
    ...
    public void shouldCreateTrelloCard() throws Exception {
        //Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("Test", "TestDescription", "Top", "1");
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("323", new BadgesMapper(), "Test", "http://test.com");
